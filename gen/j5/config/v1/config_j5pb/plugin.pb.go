...
type BuildPlugin struct {
	...
	RunType *PluginRunType    `protobuf:"bytes,7,opt,name=run_type,json=runType,proto3" json:"run_type,omitempty"`
	// deprecated: use run_type.local
	Local *CommandSpec `protobuf:"bytes,10,opt,name=local,proto3" json:"local,omitempty"`
	// deprecated: use run_type.docker
	Docker *DockerSpec `protobuf:"bytes,11,opt,name=docker,proto3" json:"docker,omitempty"`
}
...
func (x *BuildPlugin) GetRunType() *PluginRunType {
	if x != nil {
		return x.RunType
	}
	return nil
...
type PluginRunType struct {
	...
	//
	//	*PluginRunType_Builtin
	//	*PluginRunType_Local
	//	*PluginRunType_Docker
	Type isPluginRunType_Type `protobuf_oneof:"type"`
}

func (x *PluginRunType) Reset() {
	*x = PluginRunType{}
	if protoimpl.UnsafeEnabled {
...
func (x *PluginRunType) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PluginRunType) ProtoMessage() {}

func (x *PluginRunType) ProtoReflect() protoreflect.Message {
	mi := &file_j5_config_v1_plugin_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PluginRunType.ProtoReflect.Descriptor instead.
func (*PluginRunType) Descriptor() ([]byte, []int) {
	return file_j5_config_v1_plugin_proto_rawDescGZIP(), []int{1}
}

func (m *PluginRunType) GetType() isPluginRunType_Type {
	if m != nil {
		return m.Type
	}
	return nil
...
func (x *PluginRunType) GetBuiltin() string {
	if x, ok := x.GetType().(*PluginRunType_Builtin); ok {
		return x.Builtin
	}
	return ""
}

func (x *PluginRunType) GetLocal() *CommandSpec {
	if x, ok := x.GetType().(*PluginRunType_Local); ok {
		return x.Local
	}
	return nil
}

func (x *PluginRunType) GetDocker() *DockerSpec {
	if x, ok := x.GetType().(*PluginRunType_Docker); ok {
		return x.Docker
	}
	return nil
}

type isPluginRunType_Type interface {
	isPluginRunType_Type()
}

type PluginRunType_Builtin struct {
	Builtin string `protobuf:"bytes,1,opt,name=builtin,proto3,oneof"`
}

type PluginRunType_Local struct {
	...
	Local *CommandSpec `protobuf:"bytes,2,opt,name=local,proto3,oneof"`
}

type PluginRunType_Docker struct {
	// a docker container to replace the local $PATH executable.
	Docker *DockerSpec `protobuf:"bytes,3,opt,name=docker,proto3,oneof"`
}

func (*PluginRunType_Builtin) isPluginRunType_Type() {}

func (*PluginRunType_Local) isPluginRunType_Type() {}

func (*PluginRunType_Docker) isPluginRunType_Type() {}
...
func (*PluginOverride) Descriptor() ([]byte, []int) {
	return file_j5_config_v1_plugin_proto_rawDescGZIP(), []int{5}
}
...
func (x *PluginOverride) GetRunType() *PluginRunType {
	if x != nil {
		return x.RunType
	}
	return nil
...
func (*DockerRegistryAuth_Basic) Descriptor() ([]byte, []int) {
	return file_j5_config_v1_plugin_proto_rawDescGZIP(), []int{4, 0}
}
...
func (*DockerRegistryAuth_AWSECS) Descriptor() ([]byte, []int) {
	return file_j5_config_v1_plugin_proto_rawDescGZIP(), []int{4, 1}
}
...
func (x *DockerRegistryAuth_Github) Reset() {
	*x = DockerRegistryAuth_Github{}
	if protoimpl.UnsafeEnabled {
		mi := &file_j5_config_v1_plugin_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DockerRegistryAuth_Github) Descriptor() ([]byte, []int) {
	return file_j5_config_v1_plugin_proto_rawDescGZIP(), []int{4, 2}
}
...
var file_j5_config_v1_plugin_proto_rawDesc = []byte{
	...
	0xfa, 0x02, 0x0a, 0x0b, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x12,
	0x17, 0x0a, 0x04, 0x62, 0x61, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52,
	0x04, 0x62, 0x61, 0x73, 0x65, 0x88, 0x01, 0x01, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x28, 0x0a, 0x04,
	0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x6a, 0x35, 0x2e,
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e,
	0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x37, 0x0a, 0x04, 0x6f, 0x70, 0x74, 0x73, 0x18, 0x04,
	...
	,
	...
	0x72, 0x67, 0x73, 0x12, 0x10, 0x0a, 0x03, 0x65, 0x6e, 0x76, 0x18, 0x07, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x03, 0x65, 0x6e, 0x76, 0x22, 0x45, 0x0a, 0x0b, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64,
	0x53, 0x70, 0x65, 0x63, 0x12, 0x10, 0x0a, 0x03, 0x63, 0x6d, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x76, 0x18, 0x07, 0x20, 0x03, 0x28, 0x09, 0x52, 0x03, 0x65, 0x6e, 0x76, 0x22, 0x86, 0x03, 0x0a,
	...
	0x32, 0x27, 0x2e, 0x6a, 0x35, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x76, 0x31, 0x2e,
	...
	0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x6a, 0x35, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e,
	...
	,
}
...
var file_j5_config_v1_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_j5_config_v1_plugin_proto_goTypes = []any{
	(Plugin)(0),                       // 0: j5.config.v1.Plugin
	(*BuildPlugin)(nil),               // 1: j5.config.v1.BuildPlugin
	(*PluginRunType)(nil),             // 2: j5.config.v1.PluginRunType
	(*DockerSpec)(nil),                // 3: j5.config.v1.DockerSpec
	(*CommandSpec)(nil),               // 4: j5.config.v1.CommandSpec
	(*DockerRegistryAuth)(nil),        // 5: j5.config.v1.DockerRegistryAuth
	(*PluginOverride)(nil),            // 6: j5.config.v1.PluginOverride
	nil,                               // 7: j5.config.v1.BuildPlugin.OptsEntry
	(*DockerRegistryAuth_Basic)(nil),  // 8: j5.config.v1.DockerRegistryAuth.Basic
	(*DockerRegistryAuth_AWSECS)(nil), // 9: j5.config.v1.DockerRegistryAuth.AWSECS
	(*DockerRegistryAuth_Github)(nil), // 10: j5.config.v1.DockerRegistryAuth.Github
}
var file_j5_config_v1_plugin_proto_depIdxs = []int32{
	0,  // 0: j5.config.v1.BuildPlugin.type:type_name -> j5.config.v1.Plugin
	7,  // 1: j5.config.v1.BuildPlugin.opts:type_name -> j5.config.v1.BuildPlugin.OptsEntry
	2,  // 2: j5.config.v1.BuildPlugin.run_type:type_name -> j5.config.v1.PluginRunType
	4,  // 3: j5.config.v1.BuildPlugin.local:type_name -> j5.config.v1.CommandSpec
	3,  // 4: j5.config.v1.BuildPlugin.docker:type_name -> j5.config.v1.DockerSpec
	4,  // 5: j5.config.v1.PluginRunType.local:type_name -> j5.config.v1.CommandSpec
	3,  // 6: j5.config.v1.PluginRunType.docker:type_name -> j5.config.v1.DockerSpec
	8,  // 7: j5.config.v1.DockerRegistryAuth.basic:type_name -> j5.config.v1.DockerRegistryAuth.Basic
	9,  // 8: j5.config.v1.DockerRegistryAuth.aws_ecs:type_name -> j5.config.v1.DockerRegistryAuth.AWSECS
	10, // 9: j5.config.v1.DockerRegistryAuth.github:type_name -> j5.config.v1.DockerRegistryAuth.Github
	2,  // 10: j5.config.v1.PluginOverride.run_type:type_name -> j5.config.v1.PluginRunType
...
func file_j5_config_v1_plugin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_j5_config_v1_plugin_proto_msgTypes[9].Exporter = func(v any, i int) any {
	...
	file_j5_config_v1_plugin_proto_msgTypes[1].OneofWrappers = []any{
		(*PluginRunType_Builtin)(nil),
		(*PluginRunType_Local)(nil),
		(*PluginRunType_Docker)(nil),
	}
	file_j5_config_v1_plugin_proto_msgTypes[4].OneofWrappers = []any{
