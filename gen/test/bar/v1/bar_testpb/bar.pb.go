...
var file_test_bar_v1_bar_proto_rawDesc = []byte{
	...
	0x42, 0x41, 0x52, 0x5f, 0x45, 0x4e, 0x55, 0x4d, 0x5f, 0x42, 0x41, 0x52, 0x10, 0x02, 0x42, 0x32,
	...
	0x2f, 0x62, 0x61, 0x72, 0x2f, 0x76, 0x31, 0x2f, 0x62, 0x61, 0x72, 0x5f, 0x74, 0x65, 0x73, 0x74,
...
var file_test_bar_v1_bar_proto_goTypes = []any{
...
func file_test_bar_v1_bar_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_test_bar_v1_bar_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Bar); i {
			case 0:
				return &v.state
			case 1:
