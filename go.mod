...
require (
	buf.build/gen/go/bufbuild/buf/grpc/go v1.4.0-20240517182809-0b7e724f50eb.1
	buf.build/gen/go/bufbuild/buf/protocolbuffers/go v1.34.2-20240517182809-0b7e724f50eb.2
