...
const (
	FooPublishTopic_FooEvent_FullMethodName = "/test.foo.v1.topic.FooPublishTopic/FooEvent"
)
...
var FooPublishTopic_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "test.foo.v1.topic.FooPublishTopic",
	...
	Metadata: "test/foo/v1/topic/foo.p.j5s.proto",
}
